...
export const Footer: React.FC<FooterProps> = () => {
  return (
    <footer className="bg-[#12080a] border-t border-[#3b2126] pt-10 pb-8 sm:pt-16 sm:pb-12 text-[#C2B29F] text-xs relative overflow-hidden">
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 space-y-7 sm:space-y-12 relative z-10">

        {/* Footer Navigation Grid */}
        <div className="grid grid-cols-1 md:grid-cols-12 gap-7 md:gap-8 pt-1 sm:pt-2">
          ...
          >
            <span className="text-[#F6F2EA] font-normal font-serif-display text-[17px] sm:text-[20px] block">Our Exclusivity Commitment</span>
            <p className="text-[#C2B29F] text-[13px] leading-[1.6] max-w-xs xs:max-w-sm">
          ...
          >
            <span className="text-[#F6F2EA] font-normal font-serif-display text-[17px] sm:text-[20px] block">Navigation</span>
          ...
          >
            <span className="text-[#F6F2EA] font-normal font-serif-display text-[17px] sm:text-[20px] block">Contact & Agency</span>
        ...
        <motion.div 
          ...
          className="pt-5 sm:pt-8 border-t border-[#3b2126]/60 flex flex-col sm:flex-row items-center justify-between gap-2.5 sm:gap-4 text-[#A6978A] text-[11px] text-center sm:text-left"
        >
