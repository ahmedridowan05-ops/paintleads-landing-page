...
export const Footer: React.FC<FooterProps> = () => {
  return (
    <footer className="bg-[#12080a] border-t border-[#3b2126] pt-12 sm:pt-16 pb-10 sm:pb-12 text-[#C2B29F] text-xs relative overflow-hidden">
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 space-y-8 sm:space-y-12 relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-8 md:gap-8 pt-2">
          ...
          <motion.div 
            ...
            className="space-y-3 sm:space-y-4 md:col-span-5 lg:col-span-4"
          >
            <span className="text-[#F6F2EA] font-normal font-serif-display text-[18px] sm:text-[20px] block">Our Exclusivity Commitment</span>
            ...
            <div className="flex items-center gap-2 text-[#E0B669] text-xs pt-1 sm:pt-2 font-medium">
          ...
          <motion.div 
            ...
            className="space-y-3 sm:space-y-4 md:col-span-3 lg:col-span-2 lg:col-start-7"
          >
            <span className="text-[#F6F2EA] font-normal font-serif-display text-[18px] sm:text-[20px] block">Navigation</span>
          ...
          <motion.div 
            ...
            className="space-y-3 sm:space-y-4 md:col-span-4 lg:col-span-3"
          >
            <span className="text-[#F6F2EA] font-normal font-serif-display text-[18px] sm:text-[20px] block">Contact & Agency</span>
            ...
            <p className="text-[#E0B669] text-[12px] font-medium pt-1 sm:pt-2">
        ...
        <motion.div 
          ...
          className="pt-6 sm:pt-8 border-t border-[#3b2126]/60 flex flex-col sm:flex-row items-center justify-between gap-3 sm:gap-4 text-[#A6978A] text-[11px]"
        >
