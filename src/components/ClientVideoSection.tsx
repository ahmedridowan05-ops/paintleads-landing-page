...
export const ClientVideoSection: React.FC<ClientVideoSectionProps> = ({ onSeeHowWeBuild }) => {
  ...
  return (
    <section id="client-video" className="py-10 sm:py-16 md:py-28 bg-[#221215] relative overflow-hidden border-t border-[#3b2126]">
      ...
      <div className="max-w-5xl mx-auto px-5 sm:px-6 lg:px-8 space-y-7 sm:space-y-10 md:space-y-12">
        ...
        >
          <span className="text-[10.5px] sm:text-[11px] md:text-xs uppercase tracking-[0.2em] font-semibold text-[#E0B669] block">
            Hear From A Client
          </span>

          <p className="text-[#C2B29F] text-[13.5px] sm:text-[16px] md:text-lg leading-[1.55] max-w-full xs:max-w-sm sm:max-w-xl md:max-w-none mx-auto">
          ...
          <h2 className="text-[26px] xs:text-[28px] sm:text-[36px] md:text-5xl font-normal font-serif-display text-[#F6F2EA] tracking-tight pt-1 md:pt-4">
            Meet Juscelino.
          </h2>
        </motion.div>
        ...
        >
          <div className="relative rounded-xl md:rounded-3xl overflow-hidden bg-[#180c0e] border border-[#3b2126]/60 md:border-[#3b2126] shadow-2xl group transition-colors duration-500 hover:border-[#E0B669]/40 aspect-video">
            ...
            {!isPlaying ? (
              ...
              >
                ...
                <div className="relative z-10 w-14 h-14 sm:w-18 sm:h-18 md:w-24 md:h-24 rounded-full bg-[#E0B669] flex items-center justify-center shadow-[0_0_40px_rgba(224,182,105,0.2)] group-hover:shadow-[0_0_60px_rgba(224,182,105,0.4)] group-hover:scale-110 transition-all duration-500">
                  <Play className="w-6 h-6 sm:w-7 sm:h-7 md:w-10 md:h-10 text-[#221215] fill-[#221215] ml-1 md:ml-2" />
                </div>
              </div>
            ) : (
              <iframe 
        ...
        >
          <div className="bg-gradient-to-b from-[#180c0e] to-[#12080a] border border-[#3b2126]/60 md:border-[#3b2126] rounded-2xl p-5 sm:p-8 relative">
            <div className="flex flex-col sm:flex-row items-center sm:items-start gap-3.5 sm:gap-6 text-center sm:text-left">
              <Quote className="w-6 h-6 sm:w-7 sm:h-7 md:w-8 md:h-8 text-[#E0B669] shrink-0 sm:mt-1 opacity-80" />
        ...
        >
          <p className="text-[13.5px] sm:text-[15px] md:text-base text-[#A6978A] md:text-[#C2B29F] leading-[1.6] max-w-full xs:max-w-sm sm:max-w-xl md:max-w-none mx-auto text-balance">
          ...
          <div className="flex justify-center w-full">
            <a
              ...
              className="inline-flex items-center justify-center gap-2 w-full sm:w-auto min-h-[52px] px-6 py-3 rounded-full bg-[#180c0e] md:bg-transparent hover:bg-[#281519] border border-[#3b2126]/60 md:border-[#3b2126] text-[#F6F2EA] font-semibold text-[12px] md:text-xs tracking-wider uppercase transition-all hover:gap-3 group shadow-lg md:shadow-none text-center"
            >
