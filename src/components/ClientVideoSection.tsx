...
export const ClientVideoSection: React.FC<ClientVideoSectionProps> = ({ onSeeHowWeBuild }) => {
  ...
  return (
    <section id="client-video" className="py-16 md:py-28 bg-[#221215] relative overflow-hidden border-t border-[#3b2126]">
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 space-y-10 md:space-y-12">
        ...
        >
          ...
          <p className="text-[#C2B29F] text-[15px] md:text-lg leading-[1.6] max-w-[280px] md:max-w-none mx-auto">
          ...
          <h2 className="text-[36px] md:text-5xl font-normal font-serif-display text-[#F6F2EA] tracking-tight pt-2 md:pt-4">
            Meet Juscelino.
          </h2>
        </motion.div>
          ...
          <div className="relative rounded-2xl md:rounded-3xl overflow-hidden bg-[#180c0e] border border-[#3b2126]/60 md:border-[#3b2126] shadow-2xl group transition-colors duration-500 hover:border-[#E0B669]/40 aspect-video">
            ...
            {!isPlaying ? (
              ...
              >
                ...
                {/* Custom Play Button */}
                <div className="relative z-10 w-16 h-16 md:w-24 md:h-24 rounded-full bg-[#E0B669] flex items-center justify-center shadow-[0_0_40px_rgba(224,182,105,0.2)] group-hover:shadow-[0_0_60px_rgba(224,182,105,0.4)] group-hover:scale-110 transition-all duration-500">
                  <Play className="w-6 h-6 md:w-10 md:h-10 text-[#221215] fill-[#221215] ml-1 md:ml-2" />
                </div>
              </div>
            ) : (
              <iframe 
        ...
        >
          <div className="bg-gradient-to-b from-[#180c0e] to-transparent border border-[#3b2126]/40 md:border-[#3b2126] rounded-2xl p-6 sm:p-8 relative">
            <div className="flex flex-col md:flex-row items-center md:items-start gap-4 md:gap-6 text-center md:text-left">
              <Quote className="w-6 h-6 md:w-8 md:h-8 text-[#E0B669] shrink-0 md:mt-1 opacity-60 md:opacity-80" />
              <p className="text-[19px] md:text-xl text-[#F6F2EA] font-serif-display italic leading-[1.4] md:leading-relaxed text-balance">
        ...
        <motion.div 
          ...
          className="text-center max-w-2xl mx-auto space-y-8 pt-2 md:pt-4"
        >
          <p className="text-[14.5px] md:text-base text-[#A6978A] md:text-[#C2B29F] leading-[1.6] max-w-[320px] md:max-w-none mx-auto text-balance">
          ...
          <div>
            <a
              ...
              className="inline-flex items-center justify-center gap-2 w-full md:w-auto px-6 py-4 md:py-3.5 rounded-full bg-[#180c0e] md:bg-transparent hover:bg-[#281519] border border-[#3b2126]/60 md:border-[#3b2126] text-[#F6F2EA] font-semibold text-[11px] md:text-xs tracking-[0.1em] md:tracking-wider uppercase transition-all hover:gap-3 group shadow-lg md:shadow-none"
            >
