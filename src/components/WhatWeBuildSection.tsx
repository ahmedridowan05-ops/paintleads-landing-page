...
export const WhatWeBuildSection: React.FC<WhatWeBuildSectionProps> = ({
  ...
  return (
    <section id="what-we-build" className="py-14 sm:py-20 md:py-28 bg-[#1B0D10] relative overflow-hidden">
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 space-y-12 sm:space-y-16">
        ...
        >
          <div className="space-y-3 sm:space-y-4">
            ...
            <p className="text-[#C2B29F] text-[14.5px] sm:text-[16px] md:text-lg leading-[1.6]">
              Everything your painting business needs to <span className="text-[#E0B669]">attract better projects consistently.</span>
            </p>
          </div>

          <div className="bg-[#221215] border border-[#3b2126]/60 rounded-xl p-4 sm:p-5 inline-block">
            <p className="text-[#A6978A] text-[13px] md:text-sm max-w-xl mx-auto leading-relaxed">
        ...
        <div className="relative pt-2 sm:pt-4">
          ...
          <div className="absolute left-[21px] sm:left-[27px] md:left-[39px] top-4 bottom-4 w-px bg-gradient-to-b from-[#E0B669]/30 via-[#E0B669]/10 to-transparent"></div>
            ...
            {cards.map((card, idx) => {
              ...
              return (
                <motion.div
                  ...
                  key={idx}
                  className="relative pl-[54px] sm:pl-[72px] md:pl-28 group"
                >
                  {/* Step Number / Icon */}
                  <div className="absolute left-0 top-0 w-[44px] h-[44px] sm:w-[56px] sm:h-[56px] md:w-20 md:h-20 rounded-xl sm:rounded-2xl bg-[#1B0D10] border border-[#3b2126] flex items-center justify-center text-[#E0B669] shadow-lg group-hover:border-[#E0B669]/50 group-hover:bg-[#221215] transition-all duration-300 z-10">
                    <Icon className="w-5 h-5 sm:w-6 sm:h-6 md:w-8 md:h-8 group-hover:scale-110 transition-transform duration-300" />
                  </div>

                  <div className="bg-[#221215] p-4 sm:p-6 md:p-8 rounded-xl sm:rounded-2xl md:rounded-3xl border border-[#3b2126]/50 group-hover:border-[#3b2126] transition-colors shadow-sm">
                    <h3 className="text-[18px] sm:text-[20px] md:text-2xl font-normal font-serif-display text-[#F6F2EA] mb-2 md:mb-3">
                      {card.title}
                    </h3>
                    <p className="text-[13.5px] sm:text-[14.5px] md:text-base text-[#A6978A] md:text-[#C2B29F] leading-[1.6]">
                      {card.description}
                    </p>
                  </div>
                </motion.div>
        ...
        <div className="flex justify-center pt-4 sm:pt-6">
          <button
            ...
            className="w-full sm:w-auto bg-[#E0B669] hover:bg-[#ebd08c] text-[#221215] font-bold uppercase tracking-wider text-xs sm:text-sm py-3.5 sm:py-4 px-8 rounded-full transition-all duration-300 text-center flex items-center justify-center"
          >
            Get In Touch
          </button>
        </div>
